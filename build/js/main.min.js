...
window.addEventListener("DOMContentLoaded", function () {
  ...
  (0, _slider.getSwiperHero)();
  (0, _slider.getSwiperProgramms)();
  (0, _slider.getSwiperNews)();
  (0, _slider.getSwiperReviews)();
  (0, _openMenu.openMenu)();
  (0, _openMenu.openDropMenuProgramm)();
  (0, _openMenu.openDropMenuNews)();
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/map":11,"./modules/modals/init-modals":12,"./modules/open-menu":14,"./modules/select/custom-select":16,"./modules/slider":18,"./utils/ios-vh-fix":21}],2:[function(require,module,exports){
"use strict";
...
var initMap = function initMap() {
  var map = L.map("map").on("load", function () {}).setView({
    lat: 55.028522,
    lng: 82.928281
  }, 17);
...
exports.openMenu = exports.openDropMenuProgramm = exports.openDropMenuNews = void 0;
var _scrollLock = require("../utils/scroll-lock");
window.scrollLock = new _scrollLock.ScrollLock();
var navMain = document.querySelector(".header__nav");
var navToggle = document.querySelector(".header__nav__btn");
var navDropmenuNews = document.querySelector(".header__nav__item--news");
var navDropmenuProgramms = document.querySelector(".header__nav__item--programms");
var navItemProgrammsButton = document.querySelector(".header__nav__item-programms-button");
var navItemNewsButton = document.querySelector(".header__nav__item-news-button");
    ...
    if (navMain.classList.contains("header__nav--closed")) {
      ...
      document.addEventListener("click", function (e) {
        ...
        if (!withinBoundaries) {
          ...
          if (navDropmenuNews.classList.contains("header__nav__item--button-open")) {
          ...
          if (navDropmenuProgramms.classList.contains("header__nav__item--button-open")) {
...
var openDropMenuNews = function openDropMenuNews() {
...
exports.openDropMenuNews = openDropMenuNews;
var openDropMenuProgramm = function openDropMenuProgramm() {
  navItemProgrammsButton.addEventListener("click", function () {
    if (navDropmenuProgramms.classList.contains("header__nav__item--button-close")) {
...
exports.openDropMenuProgramm = openDropMenuProgramm;

},{"../utils/scroll-lock":22}],15:[function(require,module,exports){
"use strict";
...
exports.getSwiperReviews = exports.getSwiperProgramms = exports.getSwiperNews = exports.getSwiperHero = void 0;
...
var getSwiperHero = function getSwiperHero() {
  if (!swiperContainer) {
    return;
  } else {
    var swiper = new _swiper.default(".hero", {
      speed: 1500,
      loop: true,
      pagination: {
        el: ".hero__pagination",
...
exports.getSwiperHero = getSwiperHero;
var getSwiperProgramms = function getSwiperProgramms() {
  if (!swiperContainer) {
    return;
  } else {
    var swiper = new _swiper.default(".programms__swiper ", {
      speed: 1500,
      loop: false,
      breakpoints: {
        320: {
...
exports.getSwiperProgramms = getSwiperProgramms;
var getSwiperNews = function getSwiperNews() {
  if (!swiperContainer) {
    return;
  } else {
...
exports.getSwiperNews = getSwiperNews;
var getSwiperReviews = function getSwiperReviews() {
  if (!swiperContainer) {
    return;
  } else {
...
exports.getSwiperReviews = getSwiperReviews;
